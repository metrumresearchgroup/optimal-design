...
* Lower bounds for elative standard errors (RSEs) can be obtained from the diagonals of the inverse of the FIM
...
sim_gcsf %>%
  ...
  mutate(dose = factor(paste0(dose, " μg/kg"),
                       levels = paste0(rev(sort(doses)), " μg/kg"))) %>% 
