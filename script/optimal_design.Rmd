...
The next function performs 2 steps for each replicate: (1) take the template control stream and adjusts it to point to the relevant dataset and set the random seed; and (2) runs the model using `rbabylon`.
...
poped_db_gcsf <- create.poped.database(
  ...
  #maxxt = 10*24,
  bUseGrouped_xt = TRUE,
  a = cbind(DOSE = c(2.5, 5, 10), WT = 75, TAU = 24),
